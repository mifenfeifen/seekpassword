/*
 * @Author: milu
 * @Date: 2020-07-17 14:35:06
 * @LastEditTime: 2020-07-17 16:07:58
 * @Description: 生成密码
 * 冰雪奇缘
 */
'use strict';
...
function generate_password(pwd, key) {
  if (pwd && key) {
    var hash = flower_password(pwd, key);
